...
function(module,__webpack_exports__,__webpack_require__){"use strict";eval('__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hasCrl8PermalinkMapValues", function() { return hasCrl8PermalinkMapValues; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updatePermalinkQueryParams", function() { return updatePermalinkQueryParams; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updatePermalinkQueryParamsMap", function() { return updatePermalinkQueryParamsMap; });\n/* harmony import */ var _constants_params__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @constants/params */ "./src/constants/params.ts");\nfunction ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }\n\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\nfunction _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }\n\n\n\n/*\n    search the permalinkParams object with the current siteNames and containerId\n    returns true if any site and containerId has permalink values\n  */\nfunction hasCrl8PermalinkMapValues(permalinkParams) {\n  return Object.keys(permalinkParams).some(function (siteName) {\n    return Object.keys(permalinkParams[siteName]).some(function (containerId) {\n      var experience = permalinkParams[siteName][containerId];\n      return Object.keys(experience).length > 0;\n    });\n  });\n}\nfunction updatePermalinkQueryParams(_ref) {\n  var allParams = _ref.allParams,\n      permalinkOptions = _ref.permalinkOptions,\n      permalinkType = _ref.permalinkType,\n      permalinkValue = _ref.permalinkValue;\n  var _window$location = window.location,\n      hash = _window$location.hash,\n      origin = _window$location.origin,\n      pathname = _window$location.pathname;\n  var queryParamsMap = Object.keys(allParams).map(function (param) {\n    var paramValue = allParams[param];\n\n    if (param === _constants_params__WEBPACK_IMPORTED_MODULE_0__["default"].PERMALINK_MAP) {\n      paramValue = btoa(JSON.stringify(allParams[param]));\n    } else if (_typeof(allParams[param]) === \'object\') {\n      paramValue = JSON.stringify(allParams[param]);\n    }\n\n    return "".concat(param, "=").concat(encodeURIComponent(paramValue));\n  });\n  var searchQuery = queryParamsMap.length ? "?".concat(queryParamsMap.join(\'&\')) : \'\';\n  var formattedUrl = origin + pathname + searchQuery + hash; // maintain client window history details while updating the url\n\n  if (permalinkOptions && permalinkOptions.pushHistoryState) {\n    window.history.pushState(_objectSpread({\n      permalinkType: permalinkType,\n      permalinkValue: permalinkValue\n    }, permalinkOptions), document.title || \'\', formattedUrl);\n  } else {\n    window.history.replaceState(window.history.state, document.title || \'\', formattedUrl);\n  }\n}\nfunction updatePermalinkQueryParamsMap(_ref2) {\n  var containerId = _ref2.containerId,\n      siteName = _ref2.siteName,\n      permalinkOptions = _ref2.permalinkOptions,\n      permalinkType = _ref2.permalinkType,\n      permalinkValue = _ref2.permalinkValue,\n      _ref2$queryParams = _ref2.queryParams,\n      _ref2$queryParams$all = _ref2$queryParams.allParams,\n      allParams = _ref2$queryParams$all === void 0 ? {} : _ref2$queryParams$all,\n      _ref2$queryParams$per = _ref2$queryParams.permalinkMap,\n      permalinkMap = _ref2$queryParams$per === void 0 ? {} : _ref2$queryParams$per;\n\n  if (siteName && containerId) {\n    if (permalinkType && permalinkValue && Object.keys(permalinkValue).length > 0) {\n      permalinkMap[siteName] = permalinkMap[siteName] || {};\n      permalinkMap[siteName][containerId] = permalinkMap[siteName][containerId] || {};\n      permalinkMap[siteName][containerId][permalinkType] = permalinkValue;\n      allParams[_constants_params__WEBPACK_IMPORTED_MODULE_0__["default"].PERMALINK_MAP] = permalinkMap;\n    } else {\n      var permalinkOnSelectedContainer = permalinkMap[siteName] && permalinkMap[siteName][containerId]; // If there are no params on the given permalink type, delete the "type" key\n\n      if (permalinkOnSelectedContainer && permalinkOnSelectedContainer[permalinkType]) {\n        delete permalinkOnSelectedContainer[permalinkType];\n        /*\n          If there are multiple experiences or sites on the same page\n          check to see if other experiences or sites have a permalink\n        */\n\n        if (!hasCrl8PermalinkMapValues(permalinkMap)) {\n          delete allParams[_constants_params__WEBPACK_IMPORTED_MODULE_0__["default"].PERMALINK_MAP];\n        }\n      }\n    }\n  }\n\n  updatePermalinkQueryParams({\n    allParams: allParams,\n    permalinkOptions: permalinkOptions,\n    permalinkType: permalinkType,\n    permalinkValue: permalinkValue\n  });\n}\n\n//# sourceURL=webpack:///./src/utils/permalinkUtils.ts?')}})},function(e,n,t){!function(n,t){e.exports=t()}(0,function(){return function(e){function n(r){if(t[r])return t[r].exports;var o=t[r]={i:r,l:!1,exports:{}};return e[r].call(o.exports,o,o.exports,n),o.l=!0,o.exports}var t={};return n.m=e,n.c=t,n.i=function(e){return e},n.d=function(e,t,r){n.o(e,t)||Object.defineProperty(e,t,{configurable:!1,enumerable:!0,get:r})},n.n=function(e){var t=e&&e.__esModule?function(){return e.default}:function(){return e};return n.d(t,"a",t),t},n.o=function(e,n){return Object.prototype.hasOwnProperty.call(e,n)},n.p="",n(n.s=14)}([function(e,n,t){"use strict";function r(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}var o=function(){function e(e,n){for(var t=0;t<n.length;t++){var r=n[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(n,t,r){return t&&e(n.prototype,t),r&&e(n,r),n}}(),i=function(){function e(n){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};r(this,e),this.debug=!!n,this.loggingEndpoint=t.loggingEndpoint||"https://edge.curalate.com/v1/error-logging/log"}return o(e,[{key:"setDebug",value:function(e){this.debug=!!e}},{key:"logDebug",value:function(e,n){this.debug&&(n?console.debug("[crl8 debug]",e,n):console.debug("[crl8 debug]",e))}},{key:"logError",value:function(e,n){var t="universalAnalytics",r=window.screen.height+"x"+window.screen.width,o=window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth||"",i=this.loggingEndpoint+"?errortype="+t+"&error="+encodeURIComponent(e)+"&width="+o+"&dimensions="+r;if(fetch(i,{method:"POST"}),n)throw new Error(e);console.error(e)}}]),e}();n.a=i},function(e,n,t){"use strict";function r(e){return e instanceof Object&&!(e instanceof Array||e instanceof Function)}function o(e){if(!r(e))throw new Error(e+" must be a plain object.");return Object.keys(e).length<=0}function i(e){return JSON.parse(JSON.stringify(e))}function a(e,n){var t=i(e);for(var o in n){var s=r(e[o])&&r(n[o]);t[o]=s?a(e[o]||{},n[o]):i(n[o])}return t}function s(e){return e.replace?e.replace(/\|/g,""):e}function c(){return Date.now()}n.b=o,n.a=a,n.d=s,n.c=c},function(e,n,t){var r,o;!function(i){var a=!1;if(r=i,void 0!==(o="function"==typeof r?r.call(n,t,n,e):r)&&(e.exports=o),a=!0,e.exports=i(),a=!0,!a){var s=window.Cookies,c=window.Cookies=i();c.noConflict=function(){return window.Cookies=s,c}}}(function(){function e(){for(var e=0,n={};e<arguments.length;e++){var t=arguments[e];for(var r in t)n[r]=t[r]}return n}function n(t){function r(n,o,i){var a;if("undefined"!=typeof document){if(arguments.length>1){if(i=e({path:"/"},r.defaults,i),"number"==typeof i.expires){var s=new Date;s.setMilliseconds(s.getMilliseconds()+864e5*i.expires),i.expires=s}i.expires=i.expires?i.expires.toUTCString():"";try{a=JSON.stringify(o),/^[\{\[]/.test(a)&&(o=a)}catch(e){}o=t.write?t.write(o,n):encodeURIComponent(String(o)).replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g,decodeURIComponent),n=encodeURIComponent(String(n)),n=n.replace(/%(23|24|26|2B|5E|60|7C)/g,decodeURIComponent),n=n.replace(/[\(\)]/g,escape);var c="";for(var l in i)i[l]&&(c+="; "+l,!0!==i[l]&&(c+="="+i[l]));return document.cookie=n+"="+o+c}n||(a={});for(var u=document.cookie?document.cookie.split("; "):[],p=/(%[0-9A-Z]{2})+/g,_=0;_<u.length;_++){var d=u[_].split("="),f=d.slice(1).join("=");'"'===f.charAt(0)&&(f=f.slice(1,-1));try{var m=d[0].replace(p,decodeURIComponent);if(f=t.read?t.read(f,m):t(f,m)||f.replace(p,decodeURIComponent),this.json)try{f=JSON.parse(f)}catch(e){}if(n===m){a=f;break}n||(a[m]=f)}catch(e){}}return a}}return r.set=r,r.get=function(e){return r.call(r,e)},r.getJSON=function(){return r.apply({json:!0},[].slice.call(arguments))},r.defaults={},r.remove=function(n,t){r(n,"",e(t,{expires:-1}))},r.withConverter=n,r}return n(function(){})})},function(e,n){function t(e,n){var t=n||0,o=r;return[o[e[t++]],o[e[t++]],o[e[t++]],o[e[t++]],"-",o[e[t++]],o[e[t++]],"-",o[e[t++]],o[e[t++]],"-",o[e[t++]],o[e[t++]],"-",o[e[t++]],o[e[t++]],o[e[t++]],o[e[t++]],o[e[t++]],o[e[t++]]].join("")}for(var r=[],o=0;o<256;++o)r[o]=(o+256).toString(16).substr(1);e.exports=t},function(e,n){var t="undefined"!=typeof crypto&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)||"undefined"!=typeof msCrypto&&"function"==typeof window.msCrypto.getRandomValues&&msCrypto.getRandomValues.bind(msCrypto);if(t){var r=new Uint8Array(16);e.exports=function(){return t(r),r}}else{var o=new Array(16);e.exports=function(){for(var e,n=0;n<16;n++)0==(3&n)&&(e=4294967296*Math.random()),o[n]=e>>>((3&n)<<3)&255;return o}}},function(e,n,t){"use strict";function r(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(n,"__esModule",{value:!0});var o=t(18),i=t(0),a=function(){function e(e,n){for(var t=0;t<n.length;t++){var r=n[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(n,t,r){return t&&e(n.prototype,t),r&&e(n,r),n}}(),s=function(){function e(){var n=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};r(this,e),this.trackers={},n.loggingEndpoint=n.loggingEndpoint||"https://edge.curalate.com/v1/error-logging/log",this.loggingEndpoint=n.loggingEndpoint,this.logger=new i.a(!1,{loggingEndpoint:n.loggingEndpoint})}return a(e,[{key:"_getTracker",value:function(e){var n=this.trackers[e];return n||void this.logger.logError("[crl8] No tracker exists for experienceId: "+e)}},{key:"init",value:function(e){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};if(this.trackers[e]){var t="[crl8]: Metrics have already been initialized for experience "+e+".";return this.logger.logError(t,!0)}n.loggingEndpoint=n.loggingEndpoint||this.loggingEndpoint;var r=new o.a(e,n);return this.trackers[e]=r,r}},{key:"destroy",value:function(e){var n=this,t=this._getTracker(e);return t?t.submitEventBatch().then(function(){t.stopBatchTimer(),delete n.trackers[e]}):Promise.resolve()}},{key:"recordEvent",value:function(e){var n=e.dynamicLandingPageDetailViewId,t=e.eventData,r=void 0===t?{}:t,o=e.eventName,i=e.experienceId,a=this._getTracker(i);if(a){n&&"string"==typeof n&&a.setDynamicLandingPageDetailViewId(n);var s=void 0;if("string"!=typeof o){return this.logger.logError("[crl8] Invalid eventName specified. Must be a string. Metrics data will not be recorded.")}if(s="record"+(o.charAt(0).toUpperCase()+o.slice(1)),"function"!=typeof a[s]){return this.logger.logError("[crl8] Invalid tracker function specified. Metrics data will not be recorded.")}return a[s](r)}}},{key:"flushEvents",value:function(e){var n=this._getTracker(e);return n?n.submitEventBatch():Promise.resolve()}},{key:"startBatchTimer",value:function(e){var n=this._getTracker(e);if(n)return n.startBatchTimer()}},{key:"stopBatchTimer",value:function(e){var n=this._getTracker(e);if(n)return n.stopBatchTimer()}}]),e}();n.default=s},function(e,n,t){"use strict";var r={eventKeys:{carouselNavigation:"cn",curalensClick:"clc",infiniteScrollLoad:"isl",itemClick:"ic",itemHover:"ih",itemImpression:"ivi",loadMoreClick:"lmc",pageImpression:"pi",pageImpressionNoContent:"pinc",pageViewableImpression:"pvi",productAddToCart:"pratc",productClick:"prc",productHover:"prh",productImpression:"prvi"},optionalFields:{contentUnderThreshold:"cut",displayType:"dt",elapsedTime:"et",itemId:"iid",metricsContainer:"c",metricsModule:"m",parentProductId:"ppid",position:"pos",productId:"pid",productStyleId:"psid",x1:"x1",x2:"x2",y1:"y1",y2:"y2"},timing:{batchSizeThreshold:15,batchTimeThreshold:1e4}};n.a=r},function(e,n,t){"use strict";t.d(n,"a",function(){return r});var r={GA:"ga",LEGACY_GAQ:"_gaq",LEGACY_GAT:"_gat"}},function(e,n,t){"use strict";function r(e){var n=e.clientApiToken,r=e.containerId,i=e.dynamicLandingPageDetailViewId,a=e.experienceId,s=e.fpcuid,c=e.metricsId,l=e.rid,u=[];return i&&u.push("id="+i),r&&u.push("cid="+r),0===c.indexOf("datasource.")&&n&&u.push("clientApiToken="+n),a&&u.push("xp="+a),l&&u.push("rid="+l),s&&u.push("fpcuid="+s),encodeURIComponent(t.i(o.d)(document.referrer))&&u.push("ref="+encodeURIComponent(t.i(o.d)(document.referrer))),u.join("&")}var o=t(1);n.a=r},function(e,n,t){"use strict";function r(e,n){var r="t:"+t.i(o.d)(e.type)+"|ts:"+t.i(o.d)(e.timestamp),i=Object.keys(n).reduce(function(r,i){return void 0!==e[i]?r+"|"+n[i]+":"+t.i(o.d)(e[i]):r},r);return encodeURIComponent(i)}var o=t(1);n.a=r},function(e,n,t){"use strict";function r(e){var n=t.i(a.a)(document.domain);i.a.set("crl8.fpcuid",e,{expires:365,domain:n,path:""})}var o=t(2),i=t.n(o),a=t(11);n.a=r},function(e,n,t){"use strict";function r(e){var n=e.split(".");return-1!==["co","com"].indexOf(n[n.length-2])?n.slice(-3).join("."):n.slice(-2).join(".")}n.a=r},function(e,n,t){"use strict";function r(e,n){if(!e.baseUrl||"string"!=typeof e.baseUrl){return n.logError("[crl8]: You must provide a valid url for baseUrl.",!0)}if(!e.metricsId||"string"!=typeof e.metricsId){return n.logError("[crl8]: You must provide a string value for metricsId.",!0)}if(!e.pixelName||"string"!=typeof e.pixelName){return n.logError("[crl8]: You must provide a string value for pixelName.",!0)}}n.a=r},function(e,n,t){"use strict";function r(e){if(!e.requestId||"string"!=typeof e.requestId)throw new Error("[crl8] Tracking event must define a requestId field in order to be recorded.");if(!e.type||"string"!=typeof e.type)throw new Error("[crl8] Tracking event must define a type field in order to be recorded.");if(!e.timestamp||"number"!=typeof e.timestamp)throw new Error("[crl8] Tracking event must define a timestamp field in order to be recorded.")}function o(e,n,t){try{r(e)}catch(e){return t.logError(e.message),!1}switch(e.type){case n.eventKeys.pageImpression:return!!e.displayType||(t.logError('[crl8] Page impressions must define a "displayType" parameter.'),!1);case n.eventKeys.pageImpressionNoContent:return!(!e.displayType||!e.productId)||(t.logError('[crl8] Page no-content impressions must define "displayType" and "productId" parameters.'),!1);case n.eventKeys.pageViewableImpression:return!!e.elapsedTime||(t.logError('[crl8] Viewable impressions must define an "elapsedTime" parameter.'),!1);case n.eventKeys.itemImpression:return!!(e.itemId&&e.elapsedTime&&e.position)||(t.logError('[crl8] Item impressions must define "itemId", "elapsedTime" and "position" parameters.'),!1);case n.eventKeys.itemHover:return!(!e.itemId||!e.position)||(t.logError('[crl8] Item hovers must include "itemId" and "position" parameters.'),!1);case n.eventKeys.itemClick:return!(!e.itemId||!e.position)||(t.logError('[crl8] Item clicks must include "itemId" and "position" parameters.'),!1);case n.eventKeys.productImpression:return!!(e.productId&&e.productStyleId&&e.position&&e.elapsedTime)||(t.logError('[crl8] Product impressions must define "productId", "productStyleId", "elapsedTime", and "position" parameters.'),!1);case n.eventKeys.productHover:return!!(e.productId&&e.productStyleId&&e.position&&e.elapsedTime)||(t.logError('[crl8] Product hovers must define "productId", "productStyleId", "elapsedTime", and "position" parameters.'),!1);case n.eventKeys.productClick:return!!(e.productId&&e.productStyleId&&e.position)||(t.logError('[crl8] Product clicks must define "productId", "productStyleId" and "position" parameters.'),!1);case n.eventKeys.productAddToCart:return!(!e.productId||!e.position)||(t.logError('[crl8] Product add-to-cart must define "productId" and "position" parameters.'),!1);case n.eventKeys.curalensClick:return!!e.itemId||(t.logError('[crl8] Curalens clicks must include "itemId" parameter.'),!1);case n.eventKeys.carouselNavigation:return-1===e.position||1===e.position||(t.logError('[crl8] Carousel navigation must include "position" parameter and the value must be -1 or 1.'),!1);case n.eventKeys.infiniteScrollLoad:return!!e.position||(t.logError('[crl8] Infinite scroll load must include "position" parameter.'),!1);case n.eventKeys.loadMoreClick:return!!e.position||(t.logError('[crl8] Load more clicks must include "position" parameter.'),!1);default:return t.logError("[crl8] Unknown event type. Cannot be validated."),!1}}n.a=o},function(e,n,t){e.exports=t(5)},function(e,n,t){"use strict";function r(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}var o=t(0),i=function(){function e(e,n){for(var t=0;t<n.length;t++){var r=n[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(n,t,r){return t&&e(n.prototype,t),r&&e(n,r),n}}(),a=function(){function e(n,t){r(this,e),this.initialized=!1,this.hasRecordedEvent=!1,this.config={customEventName:n.integrations.adobeAnalytics.customEventName||"crl8_gallery",displayType:n.displayType,eVars:n.integrations.adobeAnalytics.eVars,experienceId:n.experienceId,loggingEndpoint:n.loggingEndpoint,rid:n.rid,useStandalone:n.integrations.adobeAnalytics.useStandalone},this.logger=new o.a(t,{loggingEndpoint:this.config.loggingEndpoint}),this.checkForAdobeAnalytics(0)}return i(e,[{key:"checkForAdobeAnalytics",value:function(e){if(this.logger.logDebug("Checking for Adobe Analytics..."),window.s&&this.config.useStandalone)this.initialized=!0,this.formEventLabel();else if(window._satellite&&!this.config.useStandalone)this.initialized=!0,this.formEventLabel();else if(e>60)!window.s||window._satellite||this.config.useStandalone?!window.s&&window._satellite&&this.config.useStandalone?this.logger.logDebug('\n          Adobe Analytics configuration is incompatible. Initialization failed.\n          Standalone tracking is enabled, however the standalone Adobe "window.s" object is not present and "window._satellite" is present.\n        '):this.logger.logDebug("Adobe Analytics not detected. Initialization failed."):this.logger.logDebug('\n          Adobe Analytics configuration is incompatible. Initialization failed.\n          The standalone Adobe "window.s" object is present, but standalone tracking is not enabled and "window._satellite" is not present.\n        ');else{var n=e+1;setTimeout(this.checkForAdobeAnalytics.bind(this,n),500)}}},{key:"formEventLabel",value:function(){var e=this.config,n=e.displayType,t=e.rid,r=e.useStandalone,o="";n&&t&&(o="v1:rid="+t+"&dt="+n),this.hasRecordedEvent||(r?this.sendToStandaloneAdobeAnalytics(o):this.sendToAdobeAnalytics(o,0))}},{key:"sendToAdobeAnalytics",value:function(e,n){if(window.crl8.metrics.trackers&&window.crl8.metrics.trackers[this.config.experienceId]){var t=window.crl8.metrics.trackers[this.config.experienceId].adobeAnalytics||{};t.requestId=e,"function"==typeof window._satellite.track?(window._satellite.track(this.config.customEventName,{requestId:t.requestId}),this.hasRecordedEvent=!0):this.logger.logDebug('Adobe Analytics failed because the "window._satellite.track" function is not present.')}else if(n>60)this.logger.logDebug("Failed to send eventLabel to Adobe Analytics. Tracking failed.");else{var r=n+1;setTimeout(this.sendToAdobeAnalytics.bind(this,e,r),500)}}},{key:"sendToStandaloneAdobeAnalytics",value:function(e){if("function"==typeof window.s.tl){var n=this.config.eVars,t=window.s.linkTrackVars;window.s[n]=e,window.s.linkTrackVars=n,window.s.tl(!0,"o",e),window.s.linkTrackVars=t,this.hasRecordedEvent=!0}else this.logger.logDebug('Adobe Analytics failed because the "window.s.tl" function is not present.')}}]),e}();n.a=a},function(e,n,t){"use strict";function r(e,n,t){return n in e?Object.defineProperty(e,n,{value:t,enumerable:!0,configurable:!0,writable:!0}):e[n]=t,e}function o(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}var i=t(0),a=t(7),s=function(){function e(e,n){for(var t=0;t<n.length;t++){var r=n[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(n,t,r){return t&&e(n.prototype,t),r&&e(n,r),n}}(),c=function(){function e(n,t){var a;o(this,e),this.eventQueue=[],this.initialized=!1,this.useLegacy=!1,this.config={actions:{pageImpression:"reel.impression",itemHover:"item.hover",itemClick:"item.click",productClick:"item.shop",productAddToCart:"item.cart"},category:"curalate.fanreel."+n.metricsId,displayType:n.displayType,eventKeys:n.eventKeys,loggingEndpoint:n.loggingEndpoint,rid:n.rid},this.supportedEvents=(a={},r(a,this.config.eventKeys.pageImpression,!0),r(a,this.config.eventKeys.itemHover,!0),r(a,this.config.eventKeys.itemClick,!0),r(a,this.config.eventKeys.productClick,!0),r(a,this.config.eventKeys.productAddToCart,!0),a),this.logger=new i.a(t,{loggingEndpoint:this.config.loggingEndpoint}),this.checkForGa(0)}return s(e,[{key:"checkForGa",value:function(e){var n=a.a.GA,t=a.a.LEGACY_GAQ;if(this.logger.logDebug("Checking for GA..."),window.GoogleAnalyticsObject?this.gaObject=window.GoogleAnalyticsObject:window[n]?this.gaObject=n:window[t]&&(this.gaObject=t),this.gaObject)this.initialized=!0,this.useLegacy=this.gaObject===t;else if(e>60)this.logger.logDebug("GA not detected. Initialization failed.");else{var r=e+1;setTimeout(this.checkForGa.bind(this,r),500)}}},{key:"submitEventBatch",value:function(e){var n=this,t=e.filter(function(e){return!!n.supportedEvents[e.type]});if(!this.initialized)return void(this.eventQueue=this.eventQueue.concat(t));this.eventQueue.length&&(this.eventQueue.forEach(function(e){n.processEvent(e)}),this.eventQueue=[]),t.length&&t.forEach(function(e){n.processEvent(e)})}},{key:"processEvent",value:function(e){var n=this,t=this.config,r=t.actions,o=t.displayType,i=t.eventKeys,a=t.rid,s=[];switch(e.type){case i.pageImpression:s.push({action:r.pageImpression,params:"v1:rid="+a+"&dt="+o});break;case i.itemHover:s.push({action:r.itemHover,params:"v1:iid="+e.itemId});break;case i.itemClick:s.push({action:r.itemClick,params:"v1:iid="+e.itemId}),s.push({action:r.itemHover,params:"v1:iid="+e.itemId});break;case i.productClick:s.push({action:r.productClick,params:"v1:iid="+e.itemId+"&prid="+e.productId}),s.push({action:r.itemClick,params:"v1:iid="+e.itemId}),s.push({action:r.itemHover,params:"v1:iid="+e.itemId});break;case i.productAddToCart:s.push({action:r.productAddToCart,params:"v1:iid="+e.itemId+"&prid="+e.productId}),s.push({action:r.productClick,params:"v1:iid="+e.itemId+"&prid="+e.productId}),s.push({action:r.itemClick,params:"v1:iid="+e.itemId}),s.push({action:r.itemHover,params:"v1:iid="+e.itemId});break;default:return}s.forEach(function(e){n.useLegacy?n.sendToLegacyGa(e):n.sendToGa(e)})}},{key:"sendToGa",value:function(e){var n=window[this.gaObject].getAll&&"function"==typeof window[this.gaObject].getAll?window[this.gaObject].getAll():null;if(n&&n.length){var t=n[0].get("name")?n[0].get("name")+".send":"send";window[this.gaObject](t,"event",this.config.category,e.action,e.params,{nonInteraction:e.action===this.config.actions.pageImpression})}}},{key:"sendToLegacyGa",value:function(e){var n=a.a.LEGACY_GAQ,t=a.a.LEGACY_GAT;if(window[t]&&"function"==typeof window[t]._getTrackers&&"function"==typeof window[n].push){var r=window[t]._getTrackers(),o=r&&r.length?r[0]._getName()+".":"";window[n].push([o+"_trackEvent",this.config.category,e.action,e.params])}}}]),e}();n.a=c},,function(e,n,t){"use strict";function r(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}var o=t(2),i=t.n(o),a=t(19),s=t.n(a),c=t(6),l=t(0),u=t(1),p=t(8),_=t(12),d=t(13),f=t(10),m=t(9),h=t(16),b=t(15),g=Object.assign||function(e){for(var n=1;n<arguments.length;n++){var t=arguments[n];for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&(e[r]=t[r])}return e},v=function(){function e(e,n){for(var t=0;t<n.length;t++){var r=n[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(n,t,r){return t&&e(n.prototype,t),r&&e(n,r),n}}(),y=function(){function e(n){var o=this,a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};r(this,e),this.eventQueue=[],this.logger=new l.a(!1,{loggingEndpoint:a.loggingEndpoint});var p=t.i(u.a)(c.a,a),d=void 0;if(p.disableFirstPartyCookie)d="";else{var m=i.a.get("crl8.fpcuid");m?d=m:(d=s()(),t.i(f.a)(d))}this.config=g({experienceId:n,fpcuid:d,rid:s()()},p),(window.crl8&&crl8.debug||p.debug)&&(this.debug=!0,this.logger.setDebug(!0)),t.i(_.a)(this.config,this.logger),this.registerIntegrations(),window.addEventListener("beforeunload",function(){o.submitEventBatch()}),this.logger.logDebug("analytics initialized for "+n),this.startBatchTimer()}return v(e,[{key:"registerIntegrations",value:function(){var e=this.config.integrations;e&&!t.i(u.b)(e)&&(e.ga&&e.ga.isEnabled&&(this.ga=new h.a(this.config,this.debug)),e.adobeAnalytics&&e.adobeAnalytics.isEnabled&&(this.adobeAnalytics=new b.a(this.config,this.debug)))}},{key:"setDynamicLandingPageDetailViewId",value:function(e){this.config.dynamicLandingPageDetailViewId=e}},{key:"startBatchTimer",value:function(){var e=this;this.batchTimerId||(this.batchTimerId=window.setInterval(function(){e.logger.logDebug("batch timer reached, flushing queue..."),e.submitEventBatch()},this.config.timing.batchTimeThreshold))}},{key:"stopBatchTimer",value:function(){this.batchTimerId&&(window.clearInterval(this.batchTimerId),this.batchTimerId=null)}},{key:"resetBatchTimer",value:function(){this.batchTimerId&&(this.stopBatchTimer(),this.startBatchTimer())}},{key:"enqueueEvent",value:function(e){this.eventQueue.push(e),this.eventQueue.length>=this.config.timing.batchSizeThreshold&&this.submitEventBatch()}},{key:"submitEventBatch",value:function(){var e=this;return 0===this.eventQueue.length?Promise.resolve():(this.ga&&this.ga.submitEventBatch(this.eventQueue),new Promise(function(n,r){var o=e.config,i=o.baseUrl,a=o.metricsId,c=o.optionalFields,l=o.pixelName,u=o.validateEvents,_=t.i(p.a)(e.config),d=e.debug||u?"&crl8-validate=true":"",f=e.eventQueue.reduce(function(e,n){return e+"&e="+t.i(m.a)(n,c)},""),h=""+_+f+d+"&cache=_"+s()(),b=document.createElement("img"),g="https:"===document.location.protocol?"https:":"http:";b.src=""+g+i+"/"+a+"/"+l+"?"+h,b.style.position="absolute",b.style["z-index"]=-100,b.setAttribute("alt",""),b.setAttribute("aria-hidden",!0),b.onload=function(){e.logger.logDebug('crl8 pixel with metricsId "'+a+'" fired successfully: '+h),document.body.removeChild(b),n()},b.onerror=function(){e.logger.logDebug('crl8 pixel with metricsId "'+a+'" failed to fire: '+h),r()},document.body.appendChild(b),e.eventQueue=[],e.resetBatchTimer()}))}},{key:"recordPageImpression",value:function(e){var n=g({},e,{requestId:this.config.rid,type:this.config.eventKeys.pageImpression,timestamp:t.i(u.c)(),displayType:this.config.displayType});t.i(d.a)(n,this.config,this.logger)&&(this.enqueueEvent(n),this.logger.logDebug("registering page impression",n),this.submitEventBatch())}},{key:"recordPageImpressionNoContent",value:function(e){var n=g({},e,{requestId:this.config.rid,type:this.config.eventKeys.pageImpressionNoContent,timestamp:t.i(u.c)(),displayType:this.config.displayType});t.i(d.a)(n,this.config,this.logger)&&(this.enqueueEvent(n),this.logger.logDebug("registering page no-content impression",n),this.submitEventBatch())}},{key:"recordPageViewableImpression",value:function(e){var n=g({},e,{requestId:this.config.rid,type:this.config.eventKeys.pageViewableImpression,timestamp:t.i(u.c)()});t.i(d.a)(n,this.config,this.logger)&&(this.enqueueEvent(n),this.logger.logDebug("registering page viewable impression",n))}},{key:"recordItemImpression",value:function(e){var n=g({},e,{requestId:this.config.rid,type:this.config.eventKeys.itemImpression,timestamp:t.i(u.c)()});t.i(d.a)(n,this.config,this.logger)&&(this.enqueueEvent(n),this.logger.logDebug("registering item impression",n))}},{key:"recordItemHover",value:function(e){var n=g({},e,{requestId:this.config.rid,type:this.config.eventKeys.itemHover,timestamp:t.i(u.c)()});t.i(d.a)(n,this.config,this.logger)&&(this.enqueueEvent(n),this.logger.logDebug("registering item hover",n))}},{key:"recordItemClick",value:function(e){var n=g({},e,{requestId:this.config.rid,type:this.config.eventKeys.itemClick,timestamp:t.i(u.c)()});t.i(d.a)(n,this.config,this.logger)&&(this.enqueueEvent(n),this.logger.logDebug("registering item click",n),this.submitEventBatch())}},{key:"recordProductImpression",value:function(e){var n=g({},e,{requestId:this.config.rid,type:this.config.eventKeys.productImpression,timestamp:t.i(u.c)()});t.i(d.a)(n,this.config,this.logger)&&(this.enqueueEvent(n),this.logger.logDebug("registering product impression",n))}},{key:"recordProductHover",value:function(e){var n=g({},e,{requestId:this.config.rid,type:this.config.eventKeys.productHover,timestamp:t.i(u.c)()});t.i(d.a)(n,this.config,this.logger)&&(this.enqueueEvent(n),this.logger.logDebug("registering product hover",n))}},{key:"recordProductClick",value:function(e){var n=g({},e,{requestId:this.config.rid,type:this.config.eventKeys.productClick,timestamp:t.i(u.c)()});t.i(d.a)(n,this.config,this.logger)&&(this.enqueueEvent(n),this.logger.logDebug("registering product click",n),this.submitEventBatch())}},{key:"recordProductAddToCart",value:function(e){var n=g({},e,{requestId:this.config.rid,type:this.config.eventKeys.productAddToCart,timestamp:t.i(u.c)()});t.i(d.a)(n,this.config,this.logger)&&(this.enqueueEvent(n),this.logger.logDebug("registering product add-to-cart",n),this.submitEventBatch())}},{key:"recordCuralensClick",value:function(e){var n=g({},e,{requestId:this.config.rid,type:this.config.eventKeys.curalensClick,timestamp:t.i(u.c)()});t.i(d.a)(n,this.config,this.logger)&&(this.enqueueEvent(n),this.logger.logDebug("registering curalens click",n),this.submitEventBatch())}},{key:"recordCarouselNavigation",value:function(e){var n=g({},e,{requestId:this.config.rid,type:this.config.eventKeys.carouselNavigation,timestamp:t.i(u.c)()});t.i(d.a)(n,this.config,this.logger)&&(this.enqueueEvent(n),this.logger.logDebug("registering carousel navigation",n),this.submitEventBatch())}},{key:"recordInfiniteScrollLoad",value:function(e){var n=g({},e,{requestId:this.config.rid,type:this.config.eventKeys.infiniteScrollLoad,timestamp:t.i(u.c)()});t.i(d.a)(n,this.config,this.logger)&&(this.enqueueEvent(n),this.logger.logDebug("registering infinite scroll load",n),this.submitEventBatch())}},{key:"recordLoadMoreClick",value:function(e){var n=g({},e,{requestId:this.config.rid,type:this.config.eventKeys.loadMoreClick,timestamp:t.i(u.c)()});t.i(d.a)(n,this.config,this.logger)&&(this.enqueueEvent(n),this.logger.logDebug("registering load more click",n),this.submitEventBatch())}}]),e}();n.a=y},function(e,n,t){var r=t(20),o=t(21),i=o;i.v1=r,i.v4=o,e.exports=i},function(e,n,t){function r(e,n,t){var r=n&&t||0,u=n||[];e=e||{};var p=e.node||o,_=void 0!==e.clockseq?e.clockseq:i;if(null==p||null==_){var d=a();null==p&&(p=o=[1|d[0],d[1],d[2],d[3],d[4],d[5]]),null==_&&(_=i=16383&(d[6]<<8|d[7]))}var f=void 0!==e.msecs?e.msecs:(new Date).getTime(),m=void 0!==e.nsecs?e.nsecs:l+1,h=f-c+(m-l)/1e4;if(h<0&&void 0===e.clockseq&&(_=_+1&16383),(h<0||f>c)&&void 0===e.nsecs&&(m=0),m>=1e4)throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");c=f,l=m,i=_,f+=122192928e5;var b=(1e4*(268435455&f)+m)%4294967296;u[r++]=b>>>24&255,u[r++]=b>>>16&255,u[r++]=b>>>8&255,u[r++]=255&b;var g=f/4294967296*1e4&268435455;u[r++]=g>>>8&255,u[r++]=255&g,u[r++]=g>>>24&15|16,u[r++]=g>>>16&255,u[r++]=_>>>8|128,u[r++]=255&_;for(var v=0;v<6;++v)u[r+v]=p[v];return n||s(u)}var o,i,a=t(4),s=t(3),c=0,l=0;e.exports=r},function(e,n,t){function r(e,n,t){var r=n&&t||0;"string"==typeof e&&(n="binary"===e?new Array(16):null,e=null),e=e||{};var a=e.random||(e.rng||o)();if(a[6]=15&a[6]|64,a[8]=63&a[8]|128,n)for(var s=0;s<16;++s)n[r+s]=a[s];return n||i(a)}var o=t(4),i=t(3);e.exports=r}])})},function(e,n,t){!function(n,t){e.exports=t()}(0,function(){return function(e){function n(r){if(t[r])return t[r].exports;var o=t[r]={i:r,l:!1,exports:{}};return e[r].call(o.exports,o,o.exports,n),o.l=!0,o.exports}var t={};return n.m=e,n.c=t,n.i=function(e){return e},n.d=function(e,t,r){n.o(e,t)||Object.defineProperty(e,t,{configurable:!1,enumerable:!0,get:r})},n.n=function(e){var t=e&&e.__esModule?function(){return e.default}:function(){return e};return n.d(t,"a",t),t},n.o=function(e,n){return Object.prototype.hasOwnProperty.call(e,n)},n.p="",n(n.s=17)}({17:function(e,n,t){"use strict";Object.defineProperty(n,"__esModule",{value:!0});var r={},o=null,i=["checkout","addtocart","removefromcart","viewproduct","pageview"],a=[],s=[],c={},l={},u={pixelId:"a",transactionId:"b",userId:"c",cartValue:"d",taxValue:"e",shippingValue:"f",shippingCity:"g",shippingState:"h",shippingCountry:"i",currency:"j",numProducts:"k",productId:"l",productName:"m",quantity:"n",price:"o",displayPrice:"p",sku:"q",category:"r",eventType:"s",firstPartyCuid:"t",referrer:"u",title:"v",location:"w",path:"x"},p=!1,_=function(e){return e.replace?e.replace(/\|/g,""):e},d=function(e){var n=function(e){for(var n=e+"=",t=document.cookie.split(";"),r=0;r<t.length;r++){for(var o=t[r];" "===o.charAt(0);)o=o.substring(1);if(0===o.indexOf(n))return o.substring(n.length,o.length)}return""}(e),t=n||function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(e){var n=16*Math.random()|0;return("x"===e?n:3&n|8).toString(16)})}(),r=new Date;r.setTime(r.getTime()+31536e6);var o,i=r.toGMTString(),a=document.domain.split(".");return o=-1!==["co","com"].indexOf(a[a.length-2])?"."+a.slice(-3).join("."):"."+a.slice(-2).join("."),document.cookie=e+"="+t+";expires="+i+";domain="+o+";path=/",t}("crl8.fpcuid"),f=document.referrer,m=function(e,n){return e.hasOwnProperty("productId")&&e.hasOwnProperty("productName")?-1===i.indexOf(n.toLowerCase())?void console.error("crl8: Invalid event type. Event type must be one of "+i.join(", ")):(e.eventType=n.toLowerCase(),void("checkout"===e.eventType?s.push(e):a.push(e))):void console.error("crl8: Product info is missing. Product id and product name must be included for product:",e)},h=function(){return s.length>0},b=function(e){var n,t=[];if(e){for(Object.keys(c).forEach(function(e){t.push(u[e]+"="+encodeURIComponent(c[e]))}),t.push(u.numProducts+"="+(s.length+a.length)),n=0;n<s.length;n++)Object.keys(s[n]).forEach(function(e){t.push(u[e]+n+"="+encodeURIComponent(s[n][e]))});E("Preparing to send "+s.length+" product(s) as part of checkout.",s)}else t.push(u.numProducts+"="+a.length);var r=e?s.length:0;for(n=0;n<a.length;n++)Object.keys(a[n]).forEach(function(e){t.push(u[e]+(n+r)+"="+encodeURIComponent(a[n][e]))});return a.length>0&&E("Preparing to send "+a.length+" product(s).",a),Object.keys(l).forEach(function(e){t.push(u[e]+"="+encodeURIComponent(_(l[e])))}),t.push(u.firstPartyCuid+"="+d),t.push(u.referrer+"="+encodeURIComponent(_(f))),t.join("&")},g=function(e){var n=document.createElement("img"),t="https:"===document.location.protocol?"https:":"http:",r=b(e);n.src=t+"//edge.curalate.com/api/v1/pixel/"+o+"/pixel.png?"+r,n.style.position="absolute",n.style["z-index"]=-100,n.setAttribute("alt",""),n.setAttribute("aria-hidden",!0),n.onload=function(){E("Curalate pixel ID "+o+" fired successfully.")},n.onerror=function(){E("Curalate pixel "+o+" failed to fire.")},document.body.appendChild(n)},v=function(e){e&&(s=[],c={}),a=[],l={}},y=function(e){for(;e.length>0;){var n=e.shift(),t=n[0],o=Array.prototype.slice.call(n).slice(1);"function"==typeof r[t]?r[t].call(window,o):console.error("crl8: Invalid function specified: "+t)}},E=function(e,n){var t=!!document.documentMode;p&&(n&&t?console.log("[crl8 debug] "+e,JSON.stringify(n)):n?console.log("[crl8 debug] "+e,n):console.log("[crl8 debug] "+e))};r.init=function(e){o=e[0],p=!!e[1]&&e[1],E("Debug mode enabled.")},r.pageView=function(e){var n=e[0]?e[0]:{location:window.location.href};return Object.keys(l).length>0?void console.error("crl8: Only 1 pageview can be recorded at a time. Call send before adding a second pageview."):n.hasOwnProperty("location")||n.hasOwnProperty("path")?(l=n,void E("Viewed page:",n)):void console.error("crl8: must define either a location or path for Pageview events. Please add one of location or path.")},r.addToCart=function(e){var n=e[0];m(n,"addtocart"),E("Added product to cart:",n)},r.removeFromCart=function(e){var n=e[0];m(n,"removefromcart"),E("Removed product from cart:",n)},r.viewProduct=function(e){var n=e[0];m(n,"viewproduct"),E("Viewed product:",n)},r.addProduct=function(e){var n=e[0];m(n,"checkout"),E("Added product for checkout:",n)},r.addTransactionInfo=function(e){var n=e[0];return Object.keys(c).length>0?void console.error("crl8: Only 1 transaction can be added at a time. Call send before adding a second transaction."):n.hasOwnProperty("transactionId")?(c=n,void E("Added transaction info for checkout:",n)):void console.error("crl8: Transaction id must be included in info for transaction:",n)},r.send=function(e){if(!o)return void console.error("crl8: Curalate pixel must be initialized with a pixel id before data can be sent.");if(e.length>0){var n=e[0].toLowerCase(),t=e[1];i.indexOf(n.toLowerCase())>=0?("addtocart"===n?r.addToCart([t]):"viewproduct"===n?r.viewProduct([t]):"removefromcart"===n?r.removeFromCart([t]):"pageview"===n&&r.pageView([t]),g(!1),v(!1)):console.error("crl8: Unsupported event type passed in to 'send'.")}else{if(0===s.length&&0===a.length)return void console.error("crl8: 0 products have been added. At least 1 product must be added to send data.");if(Object.keys(c).length>0){if(!c.hasOwnProperty("transactionId"))return void console.error("crl8: Transaction id must be specified before checkout data can be sent.");if(!h())return void console.error("crl8: 0 checkout products have been added. At least 1 product must be added to send checkout data.")}else if(h()&&0===Object.keys(c).length)return void console.error("crl8: Transaction info must be added with addTransactionInfo before checkout data can be sent.");g(!0),v(!0)}},n.default=function(e){return!e instanceof Array&&console.error("[crl8]: Pixel must be initialized with an array"),y(e),function(){e=[],e.push(arguments),y(e)}}}})})},function(e,n,t){t(0)}]);
if (window.crl8.EventBus) {
window.crl8.EventBus.dispatchEvent('registerExperienceOptions', {
    containerId: 'custom-gallery',
    options: {"api":{"sourceId":"EMdUMLerZhCnBArE"},"metrics":{"displayType":"Gallery","integrations":{"adobeAnalytics":{"isEnabled":true,"useStandalone":false}},"metricsId":"cCZvume1"},"reportMedia":{"reelId":"cCZvume1"},"uploader":{"reelId":"cCZvume1"}}
});
window.crl8.EventBus.dispatchEvent('registerExperienceOptions', {
    containerId: 'custom-homepage',
    options: {"api":{"fixedLimit":12,"sourceId":"lFAlFKRPIFmifvNy"},"gallery":{"contentPattern":"fixedGrid","itemsPerFetch":4},"metrics":{"displayType":"Homepage","integrations":{"adobeAnalytics":{"isEnabled":true,"useStandalone":false}},"metricsId":"fossil"},"reportMedia":{"reelId":"fossil"},"uploader":{"reelId":"fossil"}}
});
window.crl8.EventBus.dispatchEvent('registerExperienceOptions', {
    containerId: 'custom-product',
    options: {"api":{"fixedLimit":12,"sourceId":"VdcTjClMOOIkelWq"},"gallery":{"contentFallback":"staticBlock","contentPattern":"fixedGrid","itemsPerFetch":4},"metrics":{"displayType":"Pdp","integrations":{"adobeAnalytics":{"isEnabled":true,"useStandalone":false}},"metricsId":"QCQd8C3I"},"reportMedia":{"reelId":"QCQd8C3I"},"uploader":{"reelId":"QCQd8C3I"}}
});
window.crl8.EventBus.dispatchEvent('registerContainerMapper', function(containerId) {
    var experienceName = containerId;
    switch(containerId) {
        case 'custom-gallery':
            experienceName = 'custom-square-grid-1553535728791';
            break;
...
window.crl8.EventBus.dispatchEvent('initializeCuralatePixel', { pixelId: 106716, useDebug: false });
window.crl8.EventBus.dispatchEvent('siteReady', { name: 'fossil-4bz6bi' });
}